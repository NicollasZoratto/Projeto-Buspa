...
Primeiro Acesso
Inicie o sistema clicando em "Iniciar Sistema"
...
Rotas: Visualize todas as rotas disponíveis
...
reservas - Reservas dos usuários
id (INTEGER, PRIMARY KEY)
...
Campus Central: Centro → Campus Universitário
...
Múltiplos horários por rota (07:00, 08:30, 10:00, etc.)
...
Backend (Client-side)
Banco SQLite no navegador com SQL.js
...
Solução: Recarregue a página e clique em "Iniciar Sistema"

Reserva não confirmada
Solução: Verifique se já existe reserva ativa para o mesmo horário

Login não funciona
Solução: Use as credenciais de exemplo ou cadastre novo usuário
